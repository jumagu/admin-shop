...
import XIcon from '@/modules/common/components/icons/XIcon.vue';
import MailIcon from '@/modules/common/components/icons/MailIcon.vue';
import GitHubIcon from '@/modules/common/components/icons/GitHubIcon.vue';
</script>
